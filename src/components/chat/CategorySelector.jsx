...
const CATEGORIES = [
  ...
  },
  {
    ...
    isPrint: true,
    submenu: [
      { id: 'print_carre', name: { fr: 'Carré (1:1)', en: 'Square (1:1)' }, prompt: { fr: 'Crée un design print format carré pour', en: 'Create a square format print design for' }, dimensions: '2100x2100' },
      { id: 'print_story', name: { fr: 'Story (9:16)', en: 'Story (9:16)' }, prompt: { fr: 'Crée un design print format story pour', en: 'Create a story format print design for' }, dimensions: '2100x3600' },
      { id: 'print_portrait', name: { fr: 'Portrait (4:5)', en: 'Portrait (4:5)' }, prompt: { fr: 'Crée un design print format portrait pour', en: 'Create a portrait format print design for' }, dimensions: '2400x3000' },
      { id: 'print_paysage', name: { fr: 'Paysage (16:9)', en: 'Landscape (16:9)' }, prompt: { fr: 'Crée un design print format paysage pour', en: 'Create a landscape format print design for' }, dimensions: '3600x2100' },
    ]
  },
  {
    id: 'social',
    icon: Share2,
    name: { fr: 'Posts, Story', en: 'Posts, Story' },
  ...
  },
  {
    id: 'pub_ads',
    icon: ShoppingBag,
    name: { fr: 'Publicité / Ads', en: 'Advertising / Ads' },
    description: { fr: 'Créez des visuels publicitaires percutants', en: 'Create impactful advertising visuals' },
    prompt: { fr: '', en: '' },
    hasSubmenu: true,
    defaultExpertMode: false,
    submenu: [
      { id: 'pub_ads_square', name: { fr: 'Carré 1:1', en: 'Square 1:1' }, prompt: { fr: '', en: '' }, dimensions: '1080x1080' },
      { id: 'pub_ads_story', name: { fr: 'Story 9:16', en: 'Story 9:16' }, prompt: { fr: '', en: '' }, dimensions: '1080x1920' },
      { id: 'pub_ads_portrait', name: { fr: 'Portrait 4:5', en: 'Portrait 4:5' }, prompt: { fr: '', en: '' }, dimensions: '1080x1350' },
      { id: 'pub_ads_landscape', name: { fr: 'Paysage 16:9', en: 'Landscape 16:9' }, prompt: { fr: '', en: '' }, dimensions: '1920x1080' },
    ]
  },
  {
    id: 'video',
  ...
  return (
    <div className="grid grid-cols-1 gap-3 w-full max-w-xl mx-auto mb-8">
      ...
      <div
        ...
        className="w-full flex items-center gap-3 px-4 py-3.5 rounded-xl transition-all cursor-pointer bg-gradient-to-r from-blue-900/40 to-white/[0.03] hover:from-blue-900/50 hover:to-white/[0.08] border border-white/10 hover:border-blue-500/20"
      >
        <div className="p-2 rounded-lg bg-white/5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-white/80 text-xs">
            {language === 'fr' 
              ? 'Tous vos visuels créés' 
              : 'All your created visuals'}
          </p>
        </div>
        <svg className="h-5 w-5 text-white/60" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
