  ...
  return (
    <div ref={ref} className={cn("relative", className)}>
      <button
        ...
        className="w-8 h-8 rounded-full overflow-hidden bg-white/5 backdrop-blur-sm border border-white/10 hover:bg-white/10 transition-colors flex items-center justify-center"
