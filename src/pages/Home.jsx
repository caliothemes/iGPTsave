...
import { Send, Loader2, Plus, Mic, Palette, SlidersHorizontal, Upload, X, Heart, ChevronDown, ChevronRight, Wand2, Video, Scissors } from 'lucide-react';
                          ...
                          {idx === messages.length - 1 && (
                            ...
                            >
                              ...
                              {idx === messages.length - 1 && !msg.visual.video_url && !(msg.visual.image_url && (msg.visual.image_url.includes('.mp4') || msg.visual.image_url.includes('/video'))) && (
                                <div className="absolute -left-2 top-16 z-40 flex flex-col gap-2">
                                  {/* Magic Editor Icon */}
                                  <button
