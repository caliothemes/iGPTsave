  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className={cn(
        ...
        {/* Hero */}
        <div className="max-w-7xl mx-auto px-6 py-16 text-center pt-24">
          ...
          <p className="text-xl text-white/60 max-w-2xl mx-auto">
            {language === 'fr' 
              ...
              : 'The most beautiful creations from our members, generated by artificial intelligence'}
          </p>
        </div>

        {/* Masonry Grid */}
        <div className="max-w-7xl mx-auto px-6 pb-32 flex-1">
          {visuals.length === 0 ? (
